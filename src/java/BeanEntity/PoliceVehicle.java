...
@NamedQueries({
    ...
    @NamedQuery(name = "PoliceVehicle.countPoliceVehicle", query = "SELECT count(p) from PoliceVehicle p")})
public class PoliceVehicle implements Serializable {
    ...
    public String toString() {
        return "BeanEntity.PoliceVehicle[ policeVehicleName=" + policeVehicleName + " ]";
    }
