...
public interface BCMSDaoLocalReader {
    ...
    public BcmsSessionFireTruck getBcmsSessionFireTruckByFireTruckName(FireTruck firetruckname);
    public BcmsSessionPoliceVehicle getBcmsSessionPoliceVehicleByPoliceVehicleName(PoliceVehicle policevehiclename);
