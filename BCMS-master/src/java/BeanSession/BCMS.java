...
//244 a 247 couper la visualisation
        // PauWare view:
    ...
    private void start() {
        try {
            ...
            _bCMS_state_machine.fires(_Route_for_fire_trucks, _Route_plan_development, _Steps_33a1_33a2_Negotiation, true, this, "route_for_fire_trucks", null, AbstractStatechart.Reentrance);
    ...
    public void close() throws Statechart_exception {
        ...
        service.createEvent(_Close, _bCMS_state_machine.current_state(), "null");
    }
    ...
    public void route_for_police_vehicles(String route_name) throws Statechart_exception {
        ...
        System.out.println(_last_police_vehicle_route);
    ...
    public void fire_truck_dispatched(String fire_truck) throws Statechart_exception {
        ...
        if (ft != null) {
            ...
            bcmsft = serviceR.getBcmsSessionFireTruckByFireTruckName(ft);
